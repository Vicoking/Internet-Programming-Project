<%@ page session="true" language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.model.Shopping"%>
<!DOCTYPE html>
<html>
<head>
...
<body bgcolor="#33CCFF">
	...
	<p>
	<center>
		<form name="shoppingForm" action="ShoppingController" method="POST">
		<select name=VCD>
	...
	<center>
		<p><a href="ShoppingController?action=VIEW">view</a>&nbsp;&nbsp;
